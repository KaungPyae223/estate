...
const PropertiesByType = () => {
  ...
  return (
    <div className={"md:grid grid-cols-3 mx-3 lg:mx-0 gap-3 py-12"}>
      <div
        className={
          " Text-Right2 flex items-center md:items-start gap-1 flex-col mb-2"
        }
      >
        <p className={"text-3xl font-bold"}>Available Properties</p>
        <button
          className={
            "my-4 bg-yellow-400 text-white py-2 px-3 gap-3 rounded-lg flex flex-row justify-between"
          }
        >
          5200+ Available Properties
        </button>
      </div>
      <div
        className={
          "col-span-2 Text-Left2 flex items-center justify-center gap-4"
        }
      >
        <div>
